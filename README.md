...
**Focal Study System** 是一款**完全从零开始构建**的原创 HarmonyOS 应用，专为智能学习管理而设计。

本项目采用最新的 HarmonyOS 6.0.1 SDK 和 ArkTS 语言开发，从架构设计到功能实现全部原创，集成了番茄工作法、AI 辅助学习、间隔重复记忆系统（SRS）等核心功能，旨在为用户提供高效的学习时间管理和学习效果提升方案。

### 🌟 项目特点

- **原创设计** - 完全自主设计开发，无任何第三方模板依赖
- **现代架构** - 采用 MVVM 架构和响应式编程范式
- **原生体验** - 充分利用 HarmonyOS 原生能力和设计语言
- **功能完整** - 从需求分析到功能实现的完整开发流程
